...
public class Map {
    ...
    public Map() {
        ...
        room1.setItem(new RangedWeapon("gun", " cool handheld gun", 5));
        ...
        room2.setItem(new MeleeWeapon("knife", " that's a dull one"));
        room2.setEnemies(new Enemy("monster", " will try too eat you", 10, weapons.get(5)) );

        room3.setRoomWest(room2);
        room3.setRoomSouth(room6);
        room3.setItem(new Item("tv", " can you even watch tv on that tv?"));
        room3.setItem(new MeleeWeapon("monsterhands", " hands made be metal"));
        ...
        room5.setItem(new MeleeWeapon("sword", " a shiny sword is laying on the ground"));
        ...
        room7.setItem(new RangedWeapon("shotgun", " big and heavy gun", 10));
        room7.setItem(new Food("chili", " chili there wake you up a slightly ", 12));

        room8.setRoomWest(room7);
        room8.setRoomEast(room9);
        room8.setItem(new MeleeWeapon("nippeltwister", " cool machine"));
        ...
        room9.setItem(new RangedWeapon("boomerang", " this boomerang have skills", 3));
