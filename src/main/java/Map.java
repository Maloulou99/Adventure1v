...
public class Map {
    ...
    public Map() {
        ...
        Weapon gun = new RangedWeapon("gun", " cool handheld gun", 5, 10);
        room1.addItem(gun);
        ...
        Weapon knife = new MeleeWeapon("knife", " that's a dull one", 12);
        room2.addItem(knife);
        ...
        Weapon monsterhands = new MeleeWeapon("monsterhands", " hands made be metal", 5);
        ...
        room4.addItem(new Food("Spaghetti", " too much cheese", -23));
        ...
        Weapon sword = new MeleeWeapon("sword", " a shiny sword is laying on the ground", 23);
        room5.addItem(sword);
        ...
        Weapon bananapell = new RangedWeapon("bananapell", " it's so shiny", 1, 12);
        ...
        Weapon shotgun = new RangedWeapon("shotgun", " big and heavy gun", 10, 10);
        ...
        Weapon nippeltwister = new MeleeWeapon("nippeltwister", " cool machine", 7);
        ...
        room9.addEnemy(boos);
        Weapon boomerang = new RangedWeapon("boomerang", " this boomerang have skills", 3, 6);
    ...
    void createNewWeapons() {
        ...
        weapon.add(new MeleeWeapon("knife", " that's a dull one", 12));
